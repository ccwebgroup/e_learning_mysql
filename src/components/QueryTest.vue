<template>
  <div class="q-px-sm">
    ...
    <div class="q-py-none">
      <q-input autofocus input-style="font-family: monospace;" v-model="query" autogrow outlined
        placeholder="Write sql statement here..." />
    </div>

    <div v-if="qResult && qResult[0]" class="q-pa-sm rounded-borders bg-amber-1 q-mt-sm">
      ...
      <div class="q-mt-sm text-center">
        <q-btn @click="$emit('setAnswer', qResult)" label="Set answer before submit!" rounded unelevated no-caps
...
onBeforeMount(() => {
  if (props.prequery) query.value = props.prequery
})
